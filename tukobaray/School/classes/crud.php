...
class Database{
	...
	private $db_user = "incredib_bachatgat";  // Change as required
	private $db_pass = "Abhijit@1986";  // Change as required
	private $db_name = "incredib_tukobaray";	// Change as required
