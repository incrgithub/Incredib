                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">		
 								<div class="form-group  form-group-lg">
									  <div class="form-line">
				<h4 class="font-bold col-pink"> School Name </h4> <input type="text" class="form-control" name="school_name" value="<?php echo $school_name; ?>" required >
									</div>
								</div>
								</div>
								 <div class="col-sm-6">		
								<div class="form-group form-group-lg">
									  <div class="form-line">
							<h4 class="font-bold col-pink">School Address </h4><input type="text" class="form-control" name="school_address" value="<?php echo $school_address; ?>" required>
									</div>
									</div>
								</div>
								...
								<div class="form-group form-group-lg">
									<div class="form-line">
		<h4 class="font-bold col-pink">Total Teaching Staff </h4><input type="number" class="form-control" name="no_of_teaching_staff" value="<?php echo $no_of_teaching_staff; ?>" required>
 									</div>
							   </div>
							   </div>
							   <div class="col-sm-3">	
								<div class="form-group form-group-lg">
									<div class="form-line">
						<h4 class="font-bold col-pink">Total Non Teaching Staff </h4><input type="number" class="form-control" name="no_of_non_teaching_staff" value="<?php echo $no_of_non_teaching_staff; ?>" required>
									</div>
							   </div>
							   </div>
							   <div class="col-sm-3">	
							   <div class="form-group form-group-lg">
									<div class="form-line">
								<h4 class="font-bold col-pink">	Total Peons </h4><input type="number" class="form-control" name="no_of_peon" value="<?php echo $no_of_peon; ?>"required>
									</div>
							   </div>
							   </div>
							   <div class="col-sm-3">	
							   <div class="form-group form-group-lg">
									<div class="form-line">
								<h4 class="font-bold col-pink">		Total Students </h4><input type="number" class="form-control" name="no_of_student" value="<?php echo $no_of_student; ?>" required>
 									</div>
							   </div>
							   </div>
							   ...
							   <div class="form-group form-group-lg">
									<div class="form-line">
									<h4 class="font-bold col-teal">	Head Master Name </h4> <input type="text" class="form-control" name="name_of_head_master" value="<?php echo $name_of_head_master; ?>" required>
							   ...
							   <div class="col-sm-6">	
 							   <div class="form-group form-group-lg">
									<div class="form-line">
									<h4 class="font-bold col-teal">	Head Master Contact No </h4><input type="number" class="form-control" maxlength="10" name="contact_no_head_master" value="<?php echo $contact_no_head_master; ?>" required size="10">
							...
							<div class="col-sm-6">	
								<div class="form-group form-group-lg">
									<div class="form-line">
									<h4 class="font-bold col-teal">	Head Clerk Name </h4><input type="text" class="form-control" name="name_of_head_clark" value="<?php echo $name_of_head_clark; ?>" required>
									</div>
							   </div>
							   </div>
							<div class="col-sm-6">	
							   <div class="form-group form-group-lg">
									<div class="form-line">
								<h4 class="font-bold col-teal">		Head Clerk Contact No </h4><input type="number" class="form-control"  maxlength="10" name="contact_no_head_clark" value="<?php echo $contact_no_head_clark; ?>" required size="10">
									</div>
							   </div>
							   </div>
							<div class="col-sm-6">	
							   <div class="form-group form-group-lg">
									<div class="form-line">
								<h4 class="font-bold col-cyan">		Username </h4><input type="text" class="form-control" name="username" value="<?php echo $username; ?>" required>
							...
							<div class="col-sm-6">	
							   <div class="form-group form-group-lg">
									<div class="form-line">
								<h4 class="font-bold col-cyan">		Password </h4><input type="password" class="form-control" name="password" value="<?php echo $password; ?>" required size="10">
									</div>
							   </div>
							</div>    
							</div>
