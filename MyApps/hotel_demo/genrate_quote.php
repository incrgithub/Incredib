 ...
 <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<div class="muted pull-right"> <a href="quoting.php" ><i class="icon-arrow-left"></i> Back </a></div>
                            </div>
							<?php
include('connect.php');
                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                        <div class="navbar">
                                         ...
                                         <div class="">
                           				<form class="form-horizontal"  method="post" action="quote_one.php" >
										  <fieldset>
										 ...
										 <div class="control-group">
                                          ...
                                          <div class="controls">
                                           <span class="input-xlarge uneditable-input"><?php echo" $cust_add " ?> </span>
										    <button type="submit" class="btn btn-info"> Generate Quote</button>
                                          </div>
                                          </div>
