...
function isAlpha(keyCode)
  ...
  <div class="row-fluid section">
                        ...
                        <div class="block">
                           ...
                           <div class="pull-left"><b><font size="+2"> ADD NEW ITEM   </font></b> </div>
							 <div class="muted pull-right"><a href="dash_stock.php" ><i class="icon-arrow-left"></i> GO BACK </a></div>       
                            </div>
                                    ...
                                    <div id="rootwizard">
                                        <div class="navbar">
                                          <div class="navbar-inner">
                                            <div class="container">
                                              <ul>
											   <li><a href="#tab4" data-toggle="tab"><font size="+2"> ADD ITEM  </font></a></li>
											  <li><a href="#tab3" data-toggle="tab"><font size="+2"> ADD GROUP </font></a></li>
											   <li><a href="#tab5" data-toggle="tab"><font size="+2"> EDIT ITEM NAME  </font></a></li>
											    <li><a href="#tab6" data-toggle="tab"><font size="+2"> EDIT GROUP NAME </font></a></li>
                                        </ul>
                                         </div>
                                          </div>
                                        </div>
           	    ...
           	    <form class="form-horizontal" action="insert_item_name.php" onSubmit="return validatedata(this)" method="post" >
                                      <fieldset>
  									   <div class="control-group">
                                          <label class="control-label" for="inputError" ><font size="+2"> ITEM GROUP </font></label>
                                          <div class="controls">
...
<?php $sql1="SELECT item_group_id,item_group_name FROM item_group_master ORDER BY item_group_name"; $result1 =mysql_query($sql1); while ($data1=mysql_fetch_assoc($result1)){?>
		   <option value ="<?php echo $data1['item_group_id'] ?>" ><?php echo $data1['item_group_name'] ?></option>
		           <?php } ?>                                                                                    
                                        ...
                                        <div class="control-group">
      									 <label class="control-label" for="typeahead"><font size="+2"> ITEM NAME </font></label>
                                          <div class="controls">
                                            <input name="item_name" type="text"   class="input-large" tabindex="2">
                                          </div>
                                      </div>
							 
									  	 <div class="control-group">		
										 <div class="controls">
								 <button type="submit" class="btn btn-info" tabindex="3"><font size="+2"> SAVE </font></button>
                                          <button type="reset" class="btn"><font size="+2">CLEAR </font></button>
										  </div>
										  </div>
                                      </fieldset>
									  </form>
			 ...
			 <div class="tab-pane" id="tab3">
               <form class="form-horizontal" action="insert_item_group.php" onSubmit="return validatedata(this)" method="post" >
                                      <fieldset>
 										<div class="control-group">
       <label class="control-label" for="typeahead"><font size="+2"> GROUP NO. </font></label>
	       <div class="controls">
<span class="input-large uneditable-input"><?php $q="select max(item_group_id) from item_group_master"; $res=mysql_query($q); $row=mysql_fetch_row($res); $itm_grp_no= $row[0]+1; echo "$itm_grp_no"; ?> </span></div>
                                        ...
                                        <div class="control-group">
       <label class="control-label" for="typeahead"><font size="+2"> GROUP NAME  </font></label>
                                          <div class="controls">
                                            <input name="item_group_name" type="text"    class="input-large">
                                          </div>
                                      </div>
							
									  	 <div class="control-group">		
										 <div class="controls">
								 <button type="submit" class="btn btn-info"> <font size="+2"> SAVE</font> </button>
                                          <button type="reset" class="btn"><font size="+2"> CLEAR</font></button>
										  </div>
										  </div>
                                      </fieldset>
                ...
                <div class="tab-pane" id="tab5">
           	    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										<thead>
		 <tr ><th><div align="center"><h4> SR.NO </h4></div></th><th><div align="center" > <h4> ITEM NAME  </h4></div></th><th><div align="center"> <h4>GROUP NAME    </h4></div></th></tr>
			...
			{  $igr_name=$data1['item_group_name'];  }
				...
				$count=$count+1;
				 ...
				 <div class="tab-pane" id="tab6">
           	    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										<thead>
		 <tr ><th><div align="center"><h4>SR.NO</h4></div></th><th><div align="center"><h4> GROUP NAME </h4></div></th></tr>
