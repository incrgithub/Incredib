                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="pull-left"><b> <h4>  CHANGE RATE </h4></b> </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										<thead>
				 <tr ><th><h4> SR.NO.</h4></th><th><h4> ITEM NAME  </h4></th><th><h4>  GROUP NAME  </h4></th> <th> <h4>REMAIN STOCK </h4> </th> <th><h4>SALES PRICE </h4>  </th> </tr>
	...
	$total_cost=0;
		...
		$total_cost= $total_cost + $cost;
			...
			{  $igr_name=$data1['item_group_name'];  }
											...
											echo"<tr>";
						               		echo"<td> $count </td> ";
									   	  	echo"<td><a href=rate_change.php?id=$item_id>$item_name </a> </td>";
  										  	echo"<td> $igr_name</td>";
