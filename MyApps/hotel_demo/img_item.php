                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										<thead>
		 <tr ><th>Sr.No</th><th>Photo</th><th>Item Name</th><th>Group </th><th> Available Stock  </th> <th> Sales Rate  </th> </tr>
									...
									echo"<tr>";
										   ...
										   if($img_name==NULL)
											...
											echo "<td width='133' height='100'><div style='width:100px;height:133px;'><img src='images/$img_name' border='0' width='133' height='100' class='img-500'></div></td>";
									   	  	...
									   	  	echo"<td><a href=stock_img_change.php?id=$item_id>$item_name </a> </td>";
