 ...
 function isAlpha(keyCode)
        ...
        <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                             <div class="pull-left"><b> Add Crushing  Stock </b> </div>
                             </div>
	...
	$total_avstock=0;
		...
		$total_avstock = $total_avstock + $available_stock ;
										   echo"<td>   $count   </td> "; 
						                   echo" <td><a href=crushing_entry.php?id=$supp_id> $supp_name  </a></td> "; 
										   echo"<td> $supp_add  </td>";
					 ...
					 <center>    Total Available Stock for Crushing  <?php echo"$total_avstock"; ?>      </center>   
              <hr>
