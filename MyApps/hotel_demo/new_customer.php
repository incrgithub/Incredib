                        ...
                        <div class="span6">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="pull-left"> <b><h3>   NEW CUSTOMER REGISTRATION </h3> </b>  </div>
                                </div>
                                <div class="block-content collapse in">

    <form name="entryform" class="form-horizontal" onSubmit="return validatedata(this)" action="insert_cust.php" method="post">
                        ...
                        <div class="span6">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="pull-left"> <b><h3> CUSTOMER LIST</h3> </b>  </div>
                                </div>
                                <div class="block-content collapse in">
                                 <table class="table">
						              <thead>
...
include('connect.php');
  $cust_id=$_SESSION['cust_id'];
	...
	$query_search="select * from cust_master  ";
...
error_reporting(0);
	...
	$cr="credit";
		...
		{
 	    $emp_id=$ecol['cust_id']; 
 	 	$emp_name= $ecol['cust_name'];
		$emp_add=$ecol['cust_add'];
		$emp_mobile=$ecol['cust_mobile'];
