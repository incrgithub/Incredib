...
<html>
    ...
    <head>
        <title>STOCK AND Change Rate</title>
        <!-- Bootstrap -->
 					 ...
 					 <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<div class="muted pull-right"> <a href="item.php" ><i class="icon-arrow-left"></i> GO BACK </a></div>
                            </div>
...
error_reporting(0);
 ...
 ?>
									  ...
									  <div class="control-group">
                                          <label class="control-label" for="typeahead"><h4>ITEM NAME  </h4></label>
                                          <div class="controls">
									  ...
									  <div class="control-group">
                                          <label class="control-label" for="typeahead"><h4> REMAIN STOCK </h4> </label>
                                          <div class="controls">
                                            <input type="text"   id="typeahead"  data-provide="typeahead" value="<?php echo"$item_stock";?>" readonly>
                                          </div>
                                      </div>
									  <div class="control-group">
                                          <label class="control-label" for="typeahead"> <h4> NEW QTY </h4> </label>
                                          <div class="controls">
                                       ...
                                       <div class="control-group">
                                          <label class="control-label" for="typeahead"><h4> SALES PRICE  </h4></label>
                                          <div class="controls">
