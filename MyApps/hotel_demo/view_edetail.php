                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="pull-left">All Expence  Bill Detail </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										<thead>
										<tr ><th>Sr.</th><th>Date</th><th> Account  </th><th>  Amount </th><th> Reference Note </th></tr>
	
										</thead>
										<tbody>
											
	<?php include('connect.php');
	$query_search="select * from all_tran where tran_type='expence' order by tran_date desc";
	$result = mysql_query($query_search) or die("Search query for ALL Tran Register is wrong  ");
	$data=NULL;
