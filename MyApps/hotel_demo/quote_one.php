...
$query="insert into quote_master values('','$bill_date','$p_no','0')";
                                    ...
                                    <div id="rootwizard">
                                        <div class="navbar">
										 ...
										 <div class="control-group">
                                          ...
                                          <div class="controls">
 									<span class="input-small uneditable-input"><?php  $q="select max(quote_id) from quote_master"; $res=mysql_query($q); $row=mysql_fetch_row($res); $bill_no= $row[0]; echo "$bill_no"; $_SESSION['bill_no']=$bill_no; ?> </span>
										 Name
...
<?php $sql_g="SELECT item_group_id,item_group_name FROM item_group_master ORDER BY item_group_name"; $result_g =mysql_query($sql_g); while ($data_g=mysql_fetch_assoc($result_g)){?>
		 ...
		 <td><input name="quantity" type="text" class="input-mini" tabindex="4" required onChange="calTotal()" /></td>
		  ...
		  <td>  </td>
		  <td>  <button type="submit"  name="save" class="btn btn-info" tabindex="13">Add Item</button></td>
		  </tr>
		  									  </table>
                                          </div>
                                          </div>
