 					 ...
 					 <div class="row-fluid section">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form class="form-horizontal" action="editGroup.php" method="post">
                                      <fieldset>
<?php
include('connect.php');
 session_start();
 $item_id =$_GET['id'];
	...
	$query_search="select * from item_group_master where item_group_id = '$item_id'";
	$result = mysql_query($query_search) or die("Search query for Item Group master table   is wrong  ");
	$data=NULL;
	$srno=1;
...
error_reporting(0);
	...
	$count=1;
		...
		$item_group_id=$ecol['item_group_id'];
		 ...
		 session_start();
 		$_SESSION['item_group_id']=$item_group_id;
...
?> 
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text"  tabindex="1"  name="item_group_name"  value="<?php echo"$item_group_name";?>" required >
                                            </div>
                                      </div>
									  
		                                  <div class="control-group">
                                           <div class="controls">
                                           <button type="submit"  tabindex="2" class="btn btn-info" name="save"> SAVE </button>
                                   </div>
                                      </div>   
                                       </fieldset>
                                    </form>
