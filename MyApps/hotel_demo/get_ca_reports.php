     ...
     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12" >
                                    <form class="form-horizontal" onSubmit="return validatedata(this)" action="set_ca_rpt.php" method="post">
                ...
                <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                    <div  class="pull-left"> <b> Detail Report from <?php $sd=date('d-m-Y', strtotime($_SESSION['rpt_start_date']));  echo"$sd"; ?>  To <?php $ed=date('d-m-Y', strtotime($_SESSION['rpt_end_date']));echo"$ed"; ?> </b>  </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12" >
                                    <form class="form-horizontal" onSubmit="return validatedata(this)" action="set_rpt.php" method="post">
										  ...
										  <table border="1">
			 <tr bgcolor="lightblue"><td><div align="center">Sr.</div></td><td><div align="center">Date</div></td><td><div align="center">Inovice No</div></td> <td><div align="center">5% Amount</div></td><td><div align="center">5% VAT </div></td><td><div align="center">12.5% Amount</div></td><td><div align="center">12.5% VAT</div></td><td><div align="center">Total Amount</div></td><td><div align="center">Total VAT</div></td></tr>
		<?php
include('connect.php');
...
error_reporting(0);
	...
	echo "confirm( \" माफ करा ! माहिती उपलब्ध नाही !  \"); window.location = 'get_report.php'; ";
	...
	$total_vat_amount=0;
		...
		echo"<td colspan=3> Total </td><td> $total_fi_amount </td><td>$total_fi_vat </td><td> $total_tw_amount </td><td>$total_tw_vat </td><td> $total_amount </td><td>$total_vat_amount </td>";
