 ...
 function isAlpha(keyCode)
        ...
        <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                             <div class="pull-left"><b> Customer Account Detail  </b> </div>
							 <div class="muted pull-right"><a href="dash_customer.php" ><i class="icon-arrow-left"></i> Back </a></div>    
                            </div>
	...
	$count=1;
		...
		$cust_mobile=$ecol['cust_mobile'];
										   ...
										   echo"<td>   $count   </td> "; 
						                   echo" <td><a href=cust_detail.php?id=$cust_id> $cust_name  </a></td> "; 
										   echo"<td> $cust_add  </td>";
