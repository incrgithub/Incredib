                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
                            <li class="brand">	<font size="3" ><?php $s=date('d F, Y'); echo"$s"; ?> </font> </li>
							<li class="dropdown">
				                    
				   <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i> Sign In   <i class="caret"></i>

                              </a>
                                <ul class="dropdown-menu"> 
                                    <li> <a tabindex="-1" href="logout.php">Log Out</a> </li>
                                    <li class="divider"></li>
                                    <li> <a tabindex="-1" href="reset.php"> Password Reset </a> </li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="nav">
