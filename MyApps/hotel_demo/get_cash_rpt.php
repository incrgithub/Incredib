     ...
     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div  class="pull-left"> <b><h4>  TOTAL COLLECTION REPORT </h4></b>  </div>
                ...
                <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                    <div  class="pull-left"><h4> <b> TOTAL COLLECTION REPORT FROM  <?php $sd=date('d-m-Y', strtotime($_SESSION['rpt_start_date']));  echo"$sd"; ?> TO <?php $ed=date('d-m-Y', strtotime($_SESSION['rpt_end_date']));echo"$ed"; ?> </b> </h4> </div>
...
include('connect.php');
 ...
 $end_d= $_SESSION['rpt_end_date'];
	...
	$query_search="select * from bill_master where bill_date between '$start_d' and '$end_d'";
...
error_reporting(0);
	...
	$tt_c=0;
		...
		$table_id=$ecol['cust_id'];
	 	$t_amount= $ecol['total_amount'];
	  ...
	  $b_date=date("d-m-Y",strtotime($bill_date));
		 ...
		 echo"<tr align=center >";   
 						           	     echo"<td>    </td> ";
 										 echo"<td colspan=3 align=center ><font size=+2> TOTAL </td>";
