 					 ...
 					 <div class="row-fluid section">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form class="form-horizontal" action="insert_add_bill.php" method="post">
                                      <fieldset>
<?php
include('connect.php');
 session_start();
...
?>
								...
								&nbsp; BILL DATE
									...
									<div class="control-group">
                                          <label class="control-label" for="typeahead"> BILL AMOUNT   </label>
                                          <div class="controls">
                                            <input type="text"  name="bill_amount" id="typeahead"  tabindex="2"  maxlength="10" data-provide="typeahead"   required>
                                          </div>
                                      </div>
