...
function isAlpha(keyCode)
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                               <div class="pull-left"><b> <h4> ADD NEW STOCK </h4></b> </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										<thead>
		 <tr ><th> <h4> SR.NO </h4> </th><th> <h4> ITEM NAME </h4></th> <th><h4> REMAIN STOCK  </h4></th> <th><h4>SALES PRICE </h4> </th> </tr>
	...
	$c=1;
	$query_search="select * from item_master where item_group_id='$c'";
	...
	$total_cost=0;
		...
		$total_cost= $total_cost + $cost;
			...
			$sql1="select item_group_name  from item_group_master where item_group_id='$item_group_id' "; 
			...
			{  $igr_name=$data1['item_group_name'];  }
											...
											echo"<tr>";
						               		echo"<td> $count </td> ";
									   	  	echo"<td><a href=stock_change.php?id=$item_id>$item_name </a> </td>";
