...
class chelp_categories extends cTable {
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "`help_categories`";
		$this->DBID = 'DB';
...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Category_ID
		$this->Category_ID = new cField('help_categories', 'help_categories', 'x_Category_ID', 'Category_ID', '`Category_ID`', '`Category_ID`', 3, -1, FALSE, '`Category_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Category_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Category_ID'] = &$this->Category_ID;

		// Language
		$this->_Language = new cField('help_categories', 'help_categories', 'x__Language', 'Language', '`Language`', '`Language`', 200, -1, FALSE, '`Language`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->fields['Language'] = &$this->_Language;

		// Category_Description
		$this->Category_Description = new cField('help_categories', 'help_categories', 'x_Category_Description', 'Category_Description', '`Category_Description`', '`Category_Description`', 200, -1, FALSE, '`Category_Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "help") {
			$sDetailUrl = $GLOBALS["help"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("help_categoriesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("help_categoriesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "help_categoriesadd.php?" . $this->UrlParm($parm);
		else
			$url = "help_categoriesadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("help_categoriesedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("help_categoriesedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("help_categoriesadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("help_categoriesadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
