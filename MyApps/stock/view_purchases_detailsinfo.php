...
class cview_purchases_details extends cTable {
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "`view_purchases_details`";
		$this->DBID = 'DB';
...
// End of mofidication Flexibility of Export Records Options, by Masino Sinaga, May 14, 2012
		...
		// Purchase_ID
		$this->Purchase_ID = new cField('view_purchases_details', 'view_purchases_details', 'x_Purchase_ID', 'Purchase_ID', '`Purchase_ID`', '`Purchase_ID`', 3, -1, FALSE, '`Purchase_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->Purchase_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Purchase_ID'] = &$this->Purchase_ID;

		// Purchase_Number
		$this->Purchase_Number = new cField('view_purchases_details', 'view_purchases_details', 'x_Purchase_Number', 'Purchase_Number', '`Purchase_Number`', '`Purchase_Number`', 200, -1, FALSE, '`Purchase_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['Purchase_Number'] = &$this->Purchase_Number;

		// Supplier_Number
		$this->Supplier_Number = new cField('view_purchases_details', 'view_purchases_details', 'x_Supplier_Number', 'Supplier_Number', '`Supplier_Number`', '`Supplier_Number`', 200, -1, FALSE, '`Supplier_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->fields['Supplier_Number'] = &$this->Supplier_Number;

		// Stock_Item
		$this->Stock_Item = new cField('view_purchases_details', 'view_purchases_details', 'x_Stock_Item', 'Stock_Item', '`Stock_Item`', '`Stock_Item`', 200, -1, FALSE, '`Stock_Item`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->fields['Stock_Item'] = &$this->Stock_Item;

		// Purchasing_Quantity
		$this->Purchasing_Quantity = new cField('view_purchases_details', 'view_purchases_details', 'x_Purchasing_Quantity', 'Purchasing_Quantity', '`Purchasing_Quantity`', '`Purchasing_Quantity`', 5, -1, FALSE, '`Purchasing_Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['Purchasing_Quantity'] = &$this->Purchasing_Quantity;

		// Purchasing_Price
		$this->Purchasing_Price = new cField('view_purchases_details', 'view_purchases_details', 'x_Purchasing_Price', 'Purchasing_Price', '`Purchasing_Price`', '`Purchasing_Price`', 5, -1, FALSE, '`Purchasing_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['Purchasing_Price'] = &$this->Purchasing_Price;

		// Selling_Price
		$this->Selling_Price = new cField('view_purchases_details', 'view_purchases_details', 'x_Selling_Price', 'Selling_Price', '`Selling_Price`', '`Selling_Price`', 5, -1, FALSE, '`Selling_Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['Selling_Price'] = &$this->Selling_Price;

		// Purchasing_Total_Amount
		$this->Purchasing_Total_Amount = new cField('view_purchases_details', 'view_purchases_details', 'x_Purchasing_Total_Amount', 'Purchasing_Total_Amount', '`Purchasing_Total_Amount`', '`Purchasing_Total_Amount`', 5, -1, FALSE, '`Purchasing_Total_Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("view_purchases_detailsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("view_purchases_detailsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "view_purchases_detailsadd.php?" . $this->UrlParm($parm);
		else
			$url = "view_purchases_detailsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("view_purchases_detailsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("view_purchases_detailsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
