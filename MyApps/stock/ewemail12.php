...
<!--
	<div class="form-group">
		...
		<div class="col-sm-10">
		<label class="radio-inline ewRadio" style="white-space: nowrap;"><input type="radio" name="contenttype" value="html" checked="checked"><?php echo $Language->Phrase("EmailFormContentTypeHtml") ?></label>
