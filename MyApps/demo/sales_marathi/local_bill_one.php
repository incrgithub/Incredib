...
$query="insert into bill_master values('','$bill_date','$p_no','0','0','0','L','No')";
	...
	while ($row = mysql_fetch_array($result))
	{
		...
		$_SESSION['cust_id']=$ecol['cust_id'];
  		...
  		?>
			 ...
			 <td><div align="center">मालाचा ग्रुप निवडा </div></td><td><div align="center"> मालाचा प्रकार निवडा   </div></td><td><div align="center">दर  </div></td><td><div id="quantity" align="center">नग </div></td><td><div id="quantity" align="center">एकूण </div></td></tr>
		<tr align="center">
