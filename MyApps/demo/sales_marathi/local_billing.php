 					 ...
 					 <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="pull-left"><h4>LOCAL बिलासाठी ग्राहक निवडा </h4></div>
								<div class="muted pull-right"><a href="#" ><i class="icon-user"></i>नवीन ग्राहक नोंदणी करा  </a></div>
	...
	<div id="boxes1">
		<div style="top:150px; left: 551.5px; display: none;" id="dialog1" class="window">
			<div align="right" style="font-weight:bold; margin:5px 3px 0 0;">
				<a href='local_billing.php'><img src='images/cross.png' width='30' style='border:none; cursor:pointer;' /></a>
			</div>
			   ...
			   <div class="block-content collapse in">
                   ...
                   <input name="cust_address" type="text"   class="input-xlarge"   tabindex="2"  placeholder=" इथे पत्ता लिहा " required >
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
  <input name="mobile_no" type="text"  maxlength="10"   onkeypress="return isNumberKey(event)"   tabindex="3" placeholder=" इथे मोबाईल नंबर लिहा  " required >
                                          </div>
                                      </div>
                                   
											<div class="control-group"><div class="controls">
                                              <button type="submit" class="btn btn-info" tabindex="5">जतन करा </button>
                                          <button type="reset" class="btn" tabindex="6">रद्द करा </button>
                                          </div>
                                      </div>
                                      </fieldset>
                                    </form>
	...
	$count=1;
		...
		$cust_mobile=$ecol['cust_mobile'];
									       ...
									       echo"<td>   $count   </td> "; 
						                   echo" <td><a href=genrate_local_bill.php?id=$cust_id> $cust_name  </a></td> "; 
										   echo"<td> $cust_add  </td>";
