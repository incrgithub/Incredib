...
$sale_date=date('Y-m-d');
 ...
 $up_query="update bill_master set bill_amount='$netTotal',total_amount='$netTotal'  where bill_id='$bill_id' ";
		...
		while ($row = mysql_fetch_array($result_stock))
 			{   	$data[] = $row;		}   
			  ...
			  { 
			   ...
			   $query="insert into sale_master values('','$sale_date','$bill_id','$item_id','$sale_price','0','0','0','$item_qty')";
...
<script>window.location.href = "final_local_bill_copy.php";	</script>