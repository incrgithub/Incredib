 ...
 <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="pull-left"><h4>  ग्राहक तपशील   </h4></div>
								<div class="muted pull-right"> <a href="local_billing.php" ><i class="icon-arrow-left"></i> मागे पहा  </a></div>
                            </div>
							<?php
include('connect.php');
                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                        <div class="navbar">
                                         ...
                                         <div class="">
                           				<form class="form-horizontal"  method="post" action="local_bill_one.php" >
										  <fieldset>
										 ...
										 <div class="control-group">
                                          ...
                                          <div class="controls">
                                           <span class="input-xlarge uneditable-input"><?php echo" $cust_add " ?> </span>
										    <button type="submit" class="btn btn-info"> बिल तयार करा </button>
                                          </div>
                                          </div>
