...
function OpenNewWindow(MyPath)
     ...
     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div  class="pull-left"> <b> Detail Cash Collection Report </b>  </div>
                ...
                <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                    <div  class="pull-left"><h4> <b> Cash Collection  from <?php $sd=date('d-m-Y', strtotime($_SESSION['rpt_start_date']));  echo"$sd"; ?>  To <?php $ed=date('d-m-Y', strtotime($_SESSION['rpt_end_date']));echo"$ed"; ?> </b> </h4> </div>
   ...
   <form class="form-horizontal" onSubmit="return validatedata(this)" action="set_cash_rpt.php" method="post">
	...
	<tr bgcolor="pink"><td>Sr.No</td><td>Transaction  Head </td>  <td align="right"> Debit Amount </td><td> Credit  Amount </td><td> Transaction Detail   </td> </tr> 
		<?php
include('connect.php');
 ...
 $end_d= $_SESSION['rpt_end_date'];
	...
	$query_search="select * from all_tran where tran_date between '$start_d' and '$end_d'";
