...
?> 
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">  ग्रुप नाव  </label>
                                          <div class="controls">
                                            <input type="text"   name="item_group_name"  value="<?php echo"$item_group_name";?>" required >
                                            </div>
                                      </div>
