...
function OpenNewWindow(MyPath)
     ...
     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div  class="pull-left"> <b> Bill Detail Report </b>  </div>
                ...
                <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                    <div  class="pull-left"> <b> Bill Report from <?php $sd=date('d-m-Y', strtotime($_SESSION['rpt_start_date']));  echo"$sd"; ?>  To <?php $ed=date('d-m-Y', strtotime($_SESSION['rpt_end_date']));echo"$ed"; ?> </b>  </div>
   ...
   <form class="form-horizontal" onSubmit="return validatedata(this)" action="set_bill_rpt.php" method="post">
	...
	<tr bgcolor="lightblue"><td><div align=" ">Sr.No</div></td><td><div align=" ">Date</div></td><td><div align=" ">Customer Name  </div></td><td><div align=" ">Bill Amount</div></td> </tr>
		<?php
include('connect.php');
	...
	$count=1;
		...
		$cust_id= $ecol['cust_id'];
	 	$total_amount= $ecol['total_amount'];
		  	 	$paid= $ecol['paid_amount'];

	
	   $total_bill=$total_bill + $total_amount;
