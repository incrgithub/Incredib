 					 ...
 					 <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="pull-left"><h4> ग्राहक पेमेंट तपशील  </h4></div>
								<div class="muted pull-right"> <a href="cust_payment.php" ><i class="icon-arrow-left"></i> मागे पहा  </a></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form class="form-horizontal" action="cust_cash_deposit.php" method="post">
                                      <fieldset>
<?php
include('connect.php');
 session_start();
 $cust_id =$_GET['id'];
	...
	$query_search="select * from customer_master where cust_id = '$cust_id'";
...
?>
									  <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text"  value="<?php echo"$cust_name";?>" id="typeahead"  data-provide="typeahead" readonly >
											पत्ता 
											  <input type="text"   id="typeahead"  data-provide="typeahead"value="<?php echo"$cust_address";?>" readonly>
                                          </div>
                                      </div>
									  ...
									  <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text"   id="typeahead"  data-provide="typeahead" value="<?php echo"$mobile";?>" readonly>
                                          </div>
                                      </div>
										    
                                       <div class="control-group">
                                          <label class="control-label" for="typeahead">उधारी  </label>
                                          <div class="controls">
									   ...
									   <div class="control-group">
                                          <label class="control-label" for="typeahead"> रोख रक्कम    </label>
                                          <div class="controls">
                                            <input type="text"   tabindex="1" name="new_amount" required>
											&nbsp;&nbsp;&nbsp;&nbsp;तारीख 
											 <input type="text"  tabindex="2" class="datepicker" name="pay_date" required>
                                          </div>
                                      </div>
									  
										  <div class="control-group">
                                          <label class="control-label" for="typeahead">खास नोंद   </label>
                                          <div class="controls">
                                            <input type="text"  tabindex="3" id="typeahead"  data-provide="typeahead"  name="extra_note">
                                          
                                  </div>
                                      </div>   
                                         <div class="control-group">
                                           <div class="controls">
                                           <button type="submit"  tabindex="4" class="btn btn-info" name="save">Save</button>
                        ...
                        <div class="span6">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="pull-left"> <b><h4> बिल तपशील  </h4> </b>  </div>
                                </div>
                                <div class="block-content collapse in">
                                 <table class="table">
						              <thead>
 	 ...
 	 $bill_id=$ecol['bill_id']; 
		...
		$j_date=date("d-m-Y" ,strtotime($bill_date));
		 ...
		 if($count%2==0)
		 {
			...
			?>                  
						<tr><td></td><td></td><td>एकूण </td><td> <?php echo"$gtotal"; ?></td> </tr>
						              </tbody>
						            </table>
                                </div>
                            </div>
                        ...
                        <div class="span6">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="pull-left"> <b><h4> पेमेंट तपशील  </h4></b></div>
...
error_reporting(0);
	...
	$jtotal=0;
		...
		$jtotal=$jtotal + $total_amount;
			...
			<tr><td></td><td>एकूण </td><td> <?php echo"$jtotal"; ?></td><td></td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
