 					 ...
 					 <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<div class="muted pull-right"> <a href="customer_view.php" ><i class="icon-arrow-left"></i> मागे पहा  </a></div>
                            </div>
...
error_reporting(0);
	...
	$cr="credit";
		...
		$j_date=date("d-m-Y" ,strtotime($bill_date));
			...
			?>                  
						<tr><td></td><td></td><td>एकूण </td> <td><?php echo"$vtotal"; ?> </td><td> <?php echo"$gtotal"; ?></td><td></td></tr>
