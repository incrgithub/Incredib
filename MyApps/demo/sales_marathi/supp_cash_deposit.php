 					 ...
 					 <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<div class="muted pull-right"> <a href="supp_payment.php" ><i class="icon-arrow-left"></i> Back </a></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form class="form-horizontal" action="supp_deposit.php" method="post">
                                      <fieldset>
<?php
include('connect.php');
 session_start();
 	...
 	$jtotal=0;
 	    foreach($data_payment as $ecol_payment) { $total_a=$ecol_payment['dr_amount']; $jtotal=$jtotal + $total_a;    }?> 			
			 					  ...
			 					  <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text"  value="<?php echo"$supp_name";?>" id="typeahead"  data-provide="typeahead" readonly >
											Address
											  <input type="text"   id="typeahead"  data-provide="typeahead"value="<?php echo"$supp_add";?>" readonly>
                                          </div>
                                      </div>
									  ...
									  <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text"   id="typeahead"  data-provide="typeahead" value="<?php echo"$supp_mobile";?>" readonly>
                                          </div>
                                      </div>
