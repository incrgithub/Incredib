 ...
 function isAlpha(keyCode)
        ...
        <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                             <div class="pull-left"><b><h4> Supplier Account Detail </h4> </b> </div>
							 <div class="muted pull-right"><a href="dash_supplier.php" ><i class="icon-arrow-left"></i> Back </a></div>    
                            </div>
	...
	$count=1;
		...
		$supp_mobile=$ecol['supp_mobile'];
										   ...
										   echo"<td>   $count   </td> "; 
						                   echo" <td><a href=supp_detail.php?id=$supp_id> $supp_name  </a></td> "; 
										   echo"<td> $supp_add  </td>";
 										   echo" <td> $supp_mobile  </td>";
  						                   echo" <td><a href=supp_edit_detail.php?id=$supp_id> EDIT  </a></td> "; 
  										   echo" </tr>";
