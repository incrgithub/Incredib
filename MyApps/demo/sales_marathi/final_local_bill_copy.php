                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="pull-left"><h4>  ग्राहक बिल तपशील   </h4></div>
								  <div class="pull-right"><h4> <a href="local_billing.php"> मागे पहा   </a>   </h4></div>
                             </div>
							<?php
  include('connect.php');
  	 session_start();
                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                        <div class="navbar">
                                         ...
                                         <div class="">
             <form class="form-horizontal" name="myform" method="post" action="local_billing.php" >
			  <button type="submit"  name="save" class="btn btn-info pull-right " tabindex="1" onClick="OpenNewWindow('localBillPrint.php')" > प्रिंट काढा  </button> 
										 <table class="table" >
 <tr > <td>नाव  </td> <td width="128"><?php echo"$cust_name"; ?> </td><td> </td> <td >पत्ता  </td> <td  ><?php echo"$cust_add"; ?> </td>  </tr>
<tr class="red-outline"> <td>बिल नं. </td> <td width="128"><?php echo"$bill_id"; ?> </td> <td>  </td>  <td > तारीख  </td> <td><?php echo"$pro_date"; ?> </td> </tr>
 	...
 	$tot= 0;
	   ...
	   $q="select * from item_master where item_id='$item_id'"; $res=mysql_query($q); $row=mysql_fetch_row($res); $item_name= $row[2];    
 		$tot=  $qty * $sale_price ;
			...
			echo"<tr align=center class='red-outline'> <td >   </td><td >   </td><td >   </td><td >एकूण बिल  </td><td>  $total_a </td></tr>";
