     ...
     <?php include("header.php");?>
      ...
      <?php include("slider.php");?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">खाते तपशील </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			हप्ते परतफेड तपशील 
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                 <form class="form-horizontal" action="insert_close.php"   method="post">
									<fieldset>
...
$_SESSION['per_id']=$per_id;
	...
	while ($row = mysql_fetch_array($result))
	{
		...
		$total=0;
  	    foreach($data as $ecol)
		{
	    $inst_date= $ecol['inst_date'];
  	 	$inst_amount= $ecol['inst_amount'];
	    $inst_id= $ecol['inst_id'];
 		$total=$total + $inst_amount; 
				$inst_dates=date('d-m-Y', strtotime($inst_date));

		 
										   echo"<td><a href=edit_inst.php?id=$inst_id>   $count </a>  </td> "; 
						                   echo" <td> $inst_dates  </a></td> "; 
										   echo"<td> $inst_amount  </td>";
  										   echo" </tr>";
										   
										   $count= $count+1;
			} ?>
			<tr bgcolor="#CC9999"><td></td><td>एकूण  </td><td  bgcolor="#CCFFFF"> <?php echo" $total";?></td></tr>
</tbody>
                                </table>
									       
											 <br>
                                        <button type="submit" class="btn btn-default">खाते बंद करा </button>
 									</fieldset>
									</form>
