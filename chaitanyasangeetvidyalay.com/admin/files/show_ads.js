  ...
  <TR>
    <TD class=titleBorderx width=30>
      <TABLE height=25 cellSpacing=2 cellPadding=0 width=25 bgColor=black>
        <TBODY>
        <TR>
          <TD id=L_12232_x class=x valign=middle align=center>X</TD>
        </TR>
        </TBODY>
      </TABLE>
    </TD>
    <TD class=titleBorder id=L_12232_2>Network Access Message:<SPAN class=TitleDescription> Access Denied</SPAN> </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    ...
    <TD width=400><SPAN class=explain><ID id=L_12232_3><B>Explanation:</B></ID></SPAN><ID id=L_12232_4><PRE>
Access to this site was blocked by system administrator</PRE>
</ID><BR><BR>
<ID id=L_12232_6>If you believe you are getting this message by mistake, try contacting your administrator or Helpdesk.</ID> <BR><BR>
    </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    <TD noWrap width=25></TD>
    <TD width=400 id=L_12232_7><B>Technical Information (for support personnel)</B>
      <UL class=adminList>
        <LI id=L_12232_8>Error Code: 403 Forbidden. Forefront TMG denied the specified Uniform Resource Locator (URL). (12232)
<LI id=L_12232_9>IP Address: 10.91.200.9
<LI id=L_12232_10>Date: 5/10/2013 6:28:53 AM [GMT]
<LI id=L_12232_11>Server: FTINDTMG09.fundtech.co.in
<LI id=L_12232_12>Source: proxy
